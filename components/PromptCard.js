  ...
  return (
    <div className="prompt_card">
      <div className="flex justify-between items-start gap-5">
        <div className="flex-1 flex justify-start items-center gap-3 cursor-pointer" onClick={() => router.push(post.creator?._id === session.user.id ? "/profile" : `/profile/${post.creator._id}`)}>
          <Image
